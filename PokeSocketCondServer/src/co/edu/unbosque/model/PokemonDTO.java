...
public class PokemonDTO implements Serializable {
	...
	public PokemonDTO(String name, String mote, String ps, String defen, String velo, String level, String attack,
	...
	// To String para que se seepare solo por comas
	public String toStringComas() {
		String res = this.name + "," + this.mote + "," + this.ps + "," + this.defen + "," + this.velo + "," + this.level
				+ "," + this.attack + "," + this.ASpecial + "," + this.ADefen + "," + Arrays.toString(this.attacks);
		return res;
	}
